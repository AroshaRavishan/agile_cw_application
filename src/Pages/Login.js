...
const Login = () => {
  ...
  const [userAvatar, setUserAvatar] = useState(""); // User avatar (if available)
  ...
  const onSubmit = async (data) => {
    try {
      ...
      setUserAvatar("https://via.placeholder.com/40"); // Replace with the actual avatar URL
      setIsLoggedIn(true);
      ...
      <div className="max-w-7xl mx-auto relative z-10 h-full flex justify-start items-center">
        <div className="bg-white rounded-5 shadow-lg w-full max-w-lg p-6">
          ...
          {!isLoggedIn ? (
            ...
            <div>
              <p className="text-sm text-[#666666] mb-4">You are successfuly logged in.</p>
              <button
